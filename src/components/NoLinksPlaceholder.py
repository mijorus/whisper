...
class NoLinksPlaceholder(Gtk.Box):
    def __init__(self, **kwargs):
        ...
        title = Gtk.Label(css_classes=['title-1'], label="No active connections")
        subt = Gtk.Label(css_classes=['dim-label'], label="To get started, connect a microphone and a speaker")
